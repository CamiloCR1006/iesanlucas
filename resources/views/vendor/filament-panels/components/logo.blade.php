...
@capture($content, $logo, $isDarkMode = false)
    ...
    @elseif (filled($logo))
        ...
        />
    @else   
    <h1 class="text-xl font-bold">Institución Educativa San Lucas</h1>
    <div class="flex justify-center">
        
        <img style="width: 200px; height: 200px;" src="{{asset('img/icon2.png')}}" alt="">
    </div>
            {{-- <div class="flex justify-center">
                <img class="h-10 w-10" src="{{asset('img/icon2.png')}}" alt="">
            </div>
        <div
            {{
                $attributes->class([
